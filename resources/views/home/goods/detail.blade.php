...
@section('main')
	...
	<form action="post" method="">
        <div class="xiangqing">
            <div class="neirong w">
                <div class="xiaomi6 fl">{{$goodDetail->good_name}}</div>
                <nav class="fr">
                    <li><a href="">概述</a></li>
                    <li>|</li>
                    <li><a href="">变焦双摄</a></li>
        ...
        <div class="jieshao mt20 w">
            <div class="left fl"><img src="{{URL::asset('/home/image/liebiao_xiaomi6.jpg')}}"></div>
            <div class="right fr">
                <div class="h3 ml20 mt20">{{$goodDetail->good_name}}</div>
